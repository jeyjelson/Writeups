...
| [Bashed](./HTB%20Labs/HTB%20Bashed%20CTF%20Writeup/README.md) | Hack The Box | Easy | ffuf, phpbash web shell, Python reverse shell, sudo pivot, cron privesc |
---
...
| [Blind SSRF with Out-of-Band Detection](./Server-Side%20Request%20Forgery%20%28SSRF%29/PortSwigger%20Blind%20SSRF%20with%20Out-of-Band%20Detection%20Lab%20Writeup/README.md) | PortSwigger | Practitioner | Blind SSRF, Burp Collaborator, OAST, Referer header injection |
...
| [File Upload LFI to RCE](./File%20Inclusion/HTB%20File%20Upload%20LFI%20to%20RCE%20CTF%20Writeup/README.md) | HTB Academy | Easy | LFI, malicious image upload, GIF8 magic bytes, MIME bypass, RCE |
| [Log Poisoning LFI to RCE](./File%20Inclusion/HTB%20Log%20Poisoning%20LFI%20to%20RCE%20CTF%20Writeup/README.md) | HTB Academy| Easy | LFI, PHP session poisoning, Apache log poisoning, User-Agent RCE |
